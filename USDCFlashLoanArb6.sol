...
contract USDCFlashLoanArb6 is IFlashLoanSimpleReceiver, ReentrancyGuard {
    ...
    uint256 public constant SWEEP_COOLDOWN = 86400; // 24 hours in seconds
    ...
    constructor(
        ...
        lastActive = block.timestamp; // Initialize lastActive
    }
